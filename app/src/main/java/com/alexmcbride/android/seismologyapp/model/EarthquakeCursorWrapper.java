...
import com.alexmcbride.android.seismologyapp.DateUtil;
...
class EarthquakeCursorWrapper extends android.database.CursorWrapper {
    ...
    Earthquake getEarthquake() {
        ...
        earthquake.setPubDate(DateUtil.parseIso8601(getString(4)));
    ...
    static ContentValues getContentValues(Earthquake earthquake) {
        ...
        contentValues.put("pubDate", DateUtil.formatIso8601(earthquake.getPubDate()));
